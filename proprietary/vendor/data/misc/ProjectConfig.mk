...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_TRAN_PROJECT CUSTOM_TRAN BOOT_LOGO MTK_PLATFORM CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
#BSP:add XLWQBHLYOO-2 by cheng.wang 20200224 start
BOOT_LOGO = hdplus1600
#BSP:add XLWQBHLYOO-2 by cheng.wang 20200224 end
BUILD_AGO_GMS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP:add custom macro by wanghanfeng 20200218 start
CUSTOM_BUILD_VERNO = CY-X657C-H6117-G
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0x80000000
#BSP:add custom macro by wanghanfeng 20200218 end
...
CUSTOM_HAL_IMGSENSOR = gc8034main_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw gc6153_serial_yuv gc6133_serial_yuv pblcgc8034main_mipi_raw pblcgc803430fps_mipi_raw pblcgc803430fpsext2_mipi_raw pblcgc6153_serial_yuv pblcgc6133_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc6153_serial_yuv gc6133_serial_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = gc8034main_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 3
#ITD:modify by camera driver team end
#BSP: modify XLWQBCPUB-156 by tao.lan 20200519 start
CUSTOM_HAL_MSENSORLIB = 
#BSP: modify XLWQBCPUB-156 by tao.lan 20200519 end
CUSTOM_HAL_SENSORS = sensor
#ITD:modify by camera driver team start
CUSTOM_HAL_SUB_IMGSENSOR = gc803430fps_mipi_raw gc803430fpsext2_mipi_raw
#ITD:modify by camera driver team end
...
#BSP: modify XLWQBHLYOO-5 by tao.lan 20200228 start
CUSTOM_KERNEL_BAROMETER = no
#BSP: modify XLWQBHLYOO-5 by tao.lan 20200228 end
...
VIRTUAL_GYROSCOPE_ALGORITHM = no
#BSP: modify XLWQBCPUB-156 by tao.lan 20200519 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = gc8034main_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw gc6153_serial_yuv gc6133_serial_yuv
#ITD:modify by camera driver team end
...
#BSP: modify XLWQBCPUB-156 by tao.lan 20200519 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc6153_serial_yuv gc6133_serial_yuv
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc8034main_mipi_raw
#ITD:modify by camera driver team end
#BSP: modify XLWQBHLYOO-242 by tao.lan 20200403 start
...
#BSP: modify XLWQBHLYOO-242 by tao.lan 20200403 end
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_STATIONARY_SENSOR = yes
CUSTOM_KERNEL_STEP_COUNTER = yes
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc803430fps_mipi_raw gc803430fpsext2_mipi_raw
#ITD:modify by camera driver team end
...
#TSD:modified XLWQBHLYOO-10 by ruijun.wu 20200303 start
CUSTOM_MODEM=x657b_h6117_d1
#TSD:modified XLWQBHLYOO-10 by ruijun.wu 20200303 end
...
#BSP:modify XLWQBHLYOO-9 by cheng.wang 20200304 start
MTK_AAL_SUPPORT = yes
#BSP:modify XLWQBHLYOO-9 by cheng.wang 20200304 end
...
#BSP:modify XLWQBHLYOO-640 by haiping.bai 20200507 start
MTK_AUDIO_HD_REC_SUPPORT = yes
#BSP:modify XLWQBHLYOO-640 by haiping.bai 20200507 end
MTK_AUDIO_HYBRID_NLE_SUPPORT = no
MTK_AUDIO_MIC_INVERSE = no
#BSP:modify audio bring up XLWQBHLYOO-6 haiping.bai 20200228 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up XLWQBHLYOO-6 haiping.bai 20200228 end
...
#BSP:modify XLWQBHLYOO-640 by haiping.bai 20200414 start
MTK_BESLOUDNESS_SUPPORT = yes
#BSP:modify XLWQBHLYOO-640 by haiping.bai 20200414 end
...
#TSD: modify XLWQBHLYOO-13 zhaopeng 20200311 start
MTK_DISABLE_CAPABILITY_SWITCH = no
#TSD: modify XLWQBHLYOO-13 zhaopeng 20200311 end
...
#BSP:modify P1 debug XLWQBHLYOO-8 by ming.chen 20200302 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:modify P1 debug XLWQBHLYOO-8 by ming.chen 20200302 end
...
#TSD modify for ETWS XLWQBHLYOO-15 by jiangerji 2020.03.09 start
MTK_ETWS_SUPPORT = yes
#TSD modify for ETWS XLWQBHLYOO-15 by jiangerji 2020.03.09 end
...
#TSD: enable-FM XLWQBHLYOO-14 by yunfei.wu 20200309 start
MTK_FMRADIO_APP = yes
...
MTK_FM_SUPPORT = yes
#TSD:modify FM LNA XLWQBCPUB-230 by tieshan.huang 2020050603 start
#MTK_FM_SUPPORT_LNA = yes
MTK_FM_GPIO_FUNC = yes
#TSD:modify FM LNA XLWQBCPUB-230 by tieshan.huang 2020050603 end
#TSD: enable FM XLWQBHLYOO-14 by yunfei.wu 20200309 end
...
MTK_IRTX_SUPPORT = no
#BSP: modify for XLWQBHLYOO-8 by ming.chen 20200302 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP: modify for XLWQBHLYOO-8 by ming.chen 20200302 end
MTK_K64_SUPPORT=no
...
#BSP:modify for XLELHLES-7 by shentao.yang 20200219 start
#BSP:modify for XLELHLES-7 by shentao.yang 20200219 end
...
#TSD modify open WFD XLWQBHLYOO-223 by tieshan.huang 20200402 start
MTK_WFD_SUPPORT = yes
#TSD modify open WFD XLWQBHLYOO-223 by tieshan.huang 20200402 end
...
CUSTOM_TRAN_PROJECT=tran_x657c
CUSTOM_TRAN_BOM=tran_x657c_g1
#SDD: add XLJLHLJY-17 by weike.xu 20191111 start
MTK_BUILD_VERNO=X657C-H6117GH-QGo-GL-220215V300
TRAN_FINGERPRINT_BUILD_VERNO=GH-GL-220215V300
...
#ITD:add cam 3pty function by hongwei.liu 20200317 start
TRAN_CAMERA_FEATURE = yes
TRAN_CAMERA_ANDROID_Q = yes
#ITD:add cam 3pty function by hongwei.liu 20200317 end
TRAN_CAM_SKIN_COMPATIBLE = yes
#ITD:add flashlight control for XLWQBHLYOO-47 by desuo.lu 20200326 start
TRAN_FLASH_SLIDE_CONTROL = yes
#ITD:add flashlight control for XLWQBHLYOO-47 by desuo.lu 20200326 end
################################ITD Camera Driver end#################################################
#OS:xindong.wang added for securitycom feature, 20200213 start
OS_SECURITYCOM_SUPPORT=yes
#OS:xindong.wang added for securitycom feature end
